...
legend({'$p_1$','$p_2$','$p_3$'},'Interpreter','latex', 'FontSize',18);
...
plot(solution.T(:,1),speval(solution.Up,5,solution.T),'-o','Linewidth',2);
...
xlabel('Time ($s$)','Interpreter','latex', 'FontSize',18);
legend({'$r_1$','$r_2$','$r_3$'},'Interpreter','latex', 'FontSize',18);

figure('name','Acceleration','position', [200, 200, 700, 300]);
plot(solution.T(:,1),speval(solution.Up,7,solution.T),'-o','Linewidth',2);  hold on; grid on;
...
xlabel('Time ($s$)','Interpreter','latex', 'FontSize',18);
legend({'Source$_1$','Source$_2$','UAV'},'Interpreter','latex', 'FontSize',18);
